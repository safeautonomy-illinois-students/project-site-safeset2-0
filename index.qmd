...
## Work Split {.section-title}

::: {.content-text}
Yafu Xiao - Implementing control input logic for controllers in response to optimization objective errors

Siyuan Gong - define optimization objective fed into controllers based on obstacle boundaries, velocity, position errors

Anay Koorapaty - exploring different trajectory planning algorithms and analyzing their tradeoffs on different tracks along with implementing lookahead logic
:::
<!-- ============================================================ -->
<!-- APPROACH -->
<!-- ============================================================ -->
