...
pre-known gate coordinates. Our goal is to replace it with a **minimum-snap trajectory tracker** —
pre-compute a smooth polynomial path through all gates, then track it live with a PD full-state
controller publishing `cmd_full_state`. This eliminates the stop-at-every-waypoint behavior and
produces fast, physically smooth flight without any vision.
:::
...
![Flowchat](static/images/system_architecture.svg){width=80% fig-align="center"}
